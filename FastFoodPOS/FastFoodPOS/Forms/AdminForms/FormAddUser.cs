...
namespace FastFoodPOS.Forms.AdminForms
{
    public partial class FormAddUser : UserControl
    {
        ...
        public FormAddUser()
        {
            ...
            validators.Add(new Validator(TextEmail, LabelEmail, "Kullanıcı Adı", "required|unique:users,email"));
            validators.Add(new Validator(TextPassword, LabelPassword, "Şifre", "required|min:1"));
            validators.Add(new Validator(TextConfirmPassword, LabelConfirmPassword, "Şifre Tekrarı", "required|min:1|compare"){ compare_control = TextPassword});
        }
