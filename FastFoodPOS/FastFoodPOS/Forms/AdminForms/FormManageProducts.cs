...
namespace FastFoodPOS.Forms.AdminForms
{
    partial class FormManageProducts : UserControl, IKeepable
    {
        ...
        {
            DialogResult result = Dialog.ConfirmDialogBox.ShowDialog("Bu ürünü silmek istediğinize emin misiniz?");
            if (result == DialogResult.Yes)
            {
                e.product.Remove();
                AlertNotification.ShowAlertMessage("Ürün başarıyla silindi", AlertNotification.AlertType.SUCCESS);
